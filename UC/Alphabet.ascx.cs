...
namespace wstcp
{
    public partial class Alphabet : System.Web.UI.UserControl
    {
        ...
        {
            string script = "function setLetter(fieldId,letter){$('#'+fieldId).val(letter);this.document.forms[0].submit();}";
            Page.ClientScript.RegisterClientScriptBlock(this.GetType(), "setLetter", script,true);
