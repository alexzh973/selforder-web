...
namespace wstcp.order
{
    public partial class detailfly : p_p
    {
        ...
        {
            return;
            string script = "<script  type='text/javascript'>closethiswithrefresh();</script>";
            //string script = "<script  type='text/javascript'>window.parent.$('#ord_" + eID+"').hide();</script>";
            Page.ClientScript.RegisterClientScriptBlock(this.GetType(), "closetr", script, false);
        }
