...
namespace wstcp
{
    ...
    public partial class orderdefault : p_p
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            TabControl1.AddTabpage("Заявка", "Заявка", pnlCart, "", "cartbtn");
        ...
        private void load_struct_single()
        {
            ...
            foreach (xTN r_tn in listTN)
            {
                ...
                sb.Append("<a href='orderdefault.aspx?tn=" + r_tn.ID + "' class='tnlink' >" + r_tn.Title.ToUpper() + "</a><br/>");
