<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="imgsel.aspx.cs" Inherits="imgsel" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function go_to(pathfieldId, pathValue) {
            ...
            //window.location='imgselect.aspx';
...
<body>
    <form id="form1" runat="server" style="padding: 0; margin: 0;">
        Выбрана <asp:TextBox ID="txSelected" runat="server"></asp:TextBox>
