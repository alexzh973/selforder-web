...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function setNomenToSystem(toSys, goodCode) {
            
            var tx = $('td[data=' + goodCode+']').html();
           
            $('td[data=' + goodCode + ']').html(tx+' <img width="20px" class="shadow"  src="../simg/'+toSys+'.png"/>'  );
        }
        ...
        $(document).ready(function () {
            ...
            $(".gooddrg").draggable({
                ...
                containment: '.g',
                helper:  function() {
                    return $('<img src="../simg/32/bricks.png"/>');
                }
            ...
            $(".syscont").droppable({
                drop: function (event, ui) {
                    ...
                    setNomenToSystem(this.id, draggable.attr("data"));
...
<asp:Content ID="Content3" ContentPlaceHolderID="place_Left" runat="server">
    <div id="sysSanit" class="ipad shadow grayfon syscont">
        
        Сантехника

    </div>
    <div id="sysKanal" class="ipad shadow grayfon syscont">
        
        Водоотведение 

    </div>
    <div id="sysVoda" class="ipad shadow grayfon syscont">
