<%@ Page Title="" Language="C#" MasterPageFile="~/common/mainpage.Master" ValidateRequest="false"
...
<asp:Content ID="Content4" ContentPlaceHolderID="place_Left" runat="Server">
    <div>
        ...
        <asp:View ID="vProfile" runat="server">
            ...
            <table class="profile shadow" cellpadding="3" width="500">
                ...
                <tr>
                    ...
                    <td class="profile-field">
                        <asp:CheckBox ID="chIsFolder" Text="" runat="server" />
                    </td>
                </tr>
                <tr>
                    <td class="profile-field-title">
