...
<asp:Content ID="Content3" ContentPlaceHolderID="place_Left" runat="Server">
    ...
    <asp:Panel ID="pnlFilter" runat="server">
            ...
            <div class="_border _grayfon">
                
                    <span class="bold">Фильтр</span>: <br/>
                <asp:DropDownList ID="dlOrgList" runat="server" AutoPostBack="True" CssClass="micro"
                    OnSelectedIndexChanged="btnSearch_Click">
                </asp:DropDownList><br/>
                <asp:DropDownList ID="dlLoginEnabled" runat="server" CssClass="micro" AutoPostBack="True"
                    OnSelectedIndexChanged="btnSearch_Click">
                ...
                <asp:DropDownList ID="dlState" runat="server" AutoPostBack="True" CssClass="micro"
                    OnSelectedIndexChanged="btnSearch_Click">
                    <asp:ListItem Value="Y">Активные</asp:ListItem>
                    <asp:ListItem Value="N">Удаленные</asp:ListItem>
                    <asp:ListItem Value="O">Все</asp:ListItem>
                </asp:DropDownList><br/>
                <asp:CheckBox ID="chUseGroups" runat="server" AutoPostBack="True" CssClass="micro"
    ...
    <asp:MultiView ID="MultiView1" runat="server">
        ...
        <asp:View ID="vList" runat="server">
            ...
            <div>
                <div>
                    поиск
                    <asp:TextBox ID="txSearch" runat="server" OnTextChanged="btnSearch_Click" CssClass="searchactive"
                        Width="200px" OnPreRender="txSearch_PreRender" ToolTip="часть фио/e-mail/телефон/номер авто"
                ...
                <script type="text/javascript">
                    function search_blank(inp, g) {
                        if (g == 1) {
                            if ($('#' + inp).val() == 'часть фио/e-mail/телефон/номер авто') {
                                $('#' + inp).val('');
                            ...
                            if ($('#' + inp).val() == '') {
                                $('#' + inp).val('часть фио/e-mail/телефон/номер авто');
            ...
            <h2>Профайл пользователя</h2>
                <table cellspacing="1" cellpadding="3" width="600px" class="profile shadow">
                    ...
                    <asp:PlaceHolder ID="place4admin" runat="server">
                        <tr>
                            ...
                            <td class="profile-field">
                                ...
                                <asp:CheckBox ID="chLoginEnable" runat="server" Text="разрешен ли вход в систему?" />
                            </td>
                        </tr>
                        <tr>
                            <td class="profile-field-title">
                               <label for="chIsFolder">группа ли это?</label> 
                            </td>
                            <td class="profile-field">
                               
                                <asp:CheckBox ClientIDMode="Predictable" ID="chIsFolder" runat="server" AutoPostBack="True" OnCheckedChanged="chIsFolder_SelectedIndexChanged"
                                    Text="" />
                            </td>
                        </tr>
                    ...
                    <asp:PlaceHolder ID="placeNotFolder" runat="server">
                        <tr>
                            ...
                            <td class="profile-field">
                                ...
                                <asp:ListItem Value="UADM" Text="Админ пользователей"></asp:ListItem>
                    ...
                    <tr><td class="profile-field-title">представитель контрагента
                            ...
                            <asp:DropDownList ID="dlSubject" runat="server" Width="50%">
                            </asp:DropDownList>
