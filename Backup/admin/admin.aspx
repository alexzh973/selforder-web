<%@ Page Title="" Language="C#" MasterPageFile="~/common/mainpage.Master" AutoEventWireup="true" CodeBehind="admin.aspx.cs" Inherits="wstcp.admin"  %>
    ...
    <asp:DataGrid ID="dgDbl3" runat="server" AllowPaging="True" CellPadding="4" 
       ...
       импорт справочника номенклатуры <asp:FileUpload ID="fileFullImport" 
        runat="server" Visible="False" /><asp:Button
           ID="Button1" runat="server" Text="запустить полный импорт" OnClick="full_import" />
...
<asp:Content ContentPlaceHolderID="place_Left" runat="server" ID="placeleft_"></asp:Content>
<asp:Content ContentPlaceHolderID="place_Right" runat="server" ID="Content3"></asp:Content>
